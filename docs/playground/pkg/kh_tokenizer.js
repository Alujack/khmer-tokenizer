/* @ts-self-types="./kh_tokenizer.d.ts" */

export class KhmerTokenizer {
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        KhmerTokenizerFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_khmertokenizer_free(ptr, 0);
    }
    /**
    ...
    contains(word) {
        ...
        const ret = wasm.khmertokenizer_contains(this.__wbg_ptr, ptr0, len0);
        return ret !== 0;
    }
    /**
     ...
     */
    constructor(options) {
        const ret = wasm.khmertokenizer_new(isLikeNone(options) ? 0 : addToExternrefTable0(options));
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        this.__wbg_ptr = ret[0];
        KhmerTokenizerFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
    /**
    ...
    segment(text) {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.khmertokenizer_segment(this.__wbg_ptr, ptr0, len0);
     ...
     */
    get size() {
        const ret = wasm.khmertokenizer_size(this.__wbg_ptr);
        return ret >>> 0;
    }
}
if (Symbol.dispose) KhmerTokenizer.prototype[Symbol.dispose] = KhmerTokenizer.prototype.free;
 ...
 * @returns {string[]}
 */
export function splitKcc(text) {
    const ptr0 = passStringToWasm0(text, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.splitKcc(ptr0, len0);
    var v2 = getArrayJsValueFromWasm0(ret[0], ret[1]).slice();
    wasm.__wbindgen_free(ret[0], ret[1] * 4, 4);
    return v2;
}
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./kh_tokenizer_bg.js": import0,
    };
}

const KhmerTokenizerFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_khmertokenizer_free(ptr, 1));
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('kh_tokenizer_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
